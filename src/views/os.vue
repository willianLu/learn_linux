<template>
  <div class="markdown-body">
    ...
    <p>
      <img src="../assets/images/os_01.png" alt="001_OS作为接口的示意图" />￼
    </p>
    <blockquote>
      <p>
        没有安装操作系统的计算机，通常被称为
      ...
      <ul>
        <li>
          如果想在
          <strong>裸机</strong> 上运行自己所编写的程序，就必须用机器语言书写程序
        </li>
    ...
    <ul>
      <li>
        是现代计算机系统中
        <strong>最基本和最重要</strong> 的系统软件
      </li>
      <li>
        是
        <strong>配置在计算机硬件上的第一层软件</strong>，是对硬件系统的首次扩展
      </li>
      <li>
        主要作用是
        <strong>管理好硬件设备</strong>，并为用户和应用程序提供一个简单的接口，以便于使用
      </li>
    ...
    <p>
      <img src="../assets/images/os_02.jpg" alt="002_机房照片" />￼
    </p>
